...
<div id="wrapper">    
		...
		<div class="main">
			...
			<div class="container">
					...
					<fieldset>
						...
						<!-- Form Name -->
						<legend class="text-center">Administrar proyectos</legend>
						...
						<!-- INICIO BUSCADOR-->
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre proyecto, carrera o jurado evaluador" onkeyup='load(1);'>
							</div>
							...
							<div class="col-md-3">
								...
								<span id="loader"></span>
							    </div><a class='btn btn-info' href='proyectos.php' >Agregar Proyecto</a>
	...
	<script type="text/javascript" src="../js/buscar_proyecto.js"></script>
	                     <!-- FIN BUSCADOR-->
        ...
        <script type="text/javascript" src="custom-proyecto.js"></script>
