			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
			            ...
			            <li><a href="editable-Carrera.php" class="active"><i class="fas fa-gavel"></i> <span>Administrar carreras</span></a></li>
			...
			<div class="container">
				...
				<div class="well form-horizontal">
					<fieldset>
						...
						<!-- Form Name -->
						<legend class="text-middle" align="center">Editar Carrera</legend>

						<!-- Text input-->

						<div class="form-group">
							<a><label class="col-md-4 control-label">Nombre Carrera</label></a>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									$ejecuta = mysqli_query($conexion, "SELECT id_facultad, nombre_carrera from carreras where id_carrera = '$idcarrera'");
                                    $name1=mysqli_fetch_array($ejecuta);
                                    $name2=$name1['nombre_carrera'];
                                    $facu=$name1['id_facultad'];

									?> 
									
									
									<input id="carrera" name="carrera" value="<?php echo $name2;?>" class="form-control"  type="text" required>

									<input type="hidden" id="usuarioAct" name="usuarioAct" value="<?php echo $varsesion;?>"  class="form-control"  type="text" required>
								
									<input type="hidden" id="id" name="id" value="<?php echo $idcarrera;?>"  class="form-control"  type="text" >
						...
						<div class="form-group">
							<a><label class="col-md-4 control-label">Facultad</label></a>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<select id="facultad" name="facultad" class="form-control" >	
										<?php
										$res=mysqli_query($conexion,"SELECT * FROM facultades WHERE id_facultad='$facu'");
										...
										<?php
										$res2=mysqli_query($conexion,"SELECT * FROM facultades WHERE id_facultad!='$facu'");
										while($row2=mysqli_fetch_array($res2))
										{
										?>
											<option value="<?php echo $row2["id_facultad"];?>"><?php echo $row2["nombre_facultad"];?></option>
						...
						<!-- Success message -->
						<div class="alert alert-success" role="alert" id="success_message" align="center"> <i class="glyphicon glyphicon-thumbs-up"></i></div>
						...
						<div class="form-group">
							...
							<div class="col-md-6" align="left">
								<a class="btn btn-danger btn-lg" href="editable-Carrera.php">Atras </a>
							</div>
						</div>
	...
	$(document).ready(function(){
		$('#registrarNuevo').click(function(){
			...
			if($('#carrera').val()==""){
				...
				if($('#facultad option:selected').val()==0){
					alertify.error("Debes agregar la facultad");
					return false;
				}
