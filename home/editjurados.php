			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
			            ...
			            <li><a href="editable-table.php" class="active"><i class="fas fa-gavel"></i> <span>Administrar jurados</span></a></li>
			...
			<div class="container">
				...
				<div class="well form-horizontal">
					<fieldset>
						...
						<!-- Form Name -->
						<legend class="text-middle" align="center">Editar Jurado</legend>

						<!-- Text input-->

						<div class="form-group">
							<a><label class="col-md-4 control-label">Nombre</label></a>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<?php  									
									$ejecuta = mysqli_query($conexion, "SELECT Nombre, Apellido, Usuario, Id_Categoria from usuarios where Id_Usuarios = '$idjurados'");
                                    $name1=mysqli_fetch_array($ejecuta);
                                    $name2=$name1['Nombre'];
                                    $apellido1=$name1['Apellido'];
                                    $usu=$name1['Usuario'];
                                 
                                    $cat1=$name1['Id_Categoria'];
									...
									<input id="nombre" name="nombre" placeholder="Ingresar Nombre" class="form-control" value="<?php echo $name2;?>" type="text" required>
									<!-- ESTE ES EL INPUT DEL USUARIO ACTIVO -->
									<input type="hidden" id="usuarioAct" name="usuarioAct" value="<?php echo $varsesion;?>"  class="form-control"  type="text" >
									<input type="hidden" id="id" name="id" value="<?php echo $idjurados;?>"  class="form-control"  type="text" >
								</div>
							</div>
						</div>

						<div class="form-group">
							<a><label class="col-md-4 control-label">Apellido</label></a>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input id="apellido" name="apellido" placeholder="Ingresar Apellido..." class="form-control"  value="<?php echo $apellido1;?>" type="text" required>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input id="user" name="user" placeholder="Ingresar Nombre..." value="<?php echo $usu;?>" class="form-control"  type="text" required>
								</div>
							</div>
						</div>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<select id="nombrecat" name="nombrecat" class="form-control">	
											<?php
										$res=mysqli_query($conexion,"SELECT * FROM categorias  WHERE Id_Categoria='$cat1'");
										...
										<?php
										$res2=mysqli_query($conexion,"SELECT * FROM categorias WHERE Id_Categoria !='$cat1'");
										while($row2=mysqli_fetch_array($res2))
										{
										?>
											<option value="<?php echo $row2["Id_Categoria"];?>"><?php echo $row2["Nombre_Categoria"];?></option>
						...
						<div class="form-group">
							...
							<div class="col-md-6" align="left">
								<a class="btn btn-danger btn-lg" href="editable-table.php">Atras </a>
							</div>
						</div>
	...
	$(document).ready(function(){
		$('#registrarNuevo').click(function(){
			...
			cadena= "nombre=" + $('#nombre').val() + 
					...
					$.ajax({
						type:"POST",
						url:"../funciones/updatejurado.php",
						data:cadena,
						success:function(r)
						{
