			...
			<div class="container">
				...
				<div class="well form-horizontal">
					<fieldset>
						...
						<!-- Form Name -->
						<legend class="text-middle" align="center">Editar Integrante </legend>
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<?php  									
									$ejecuta = mysqli_query($conexion, "SELECT * from integrante where id_integrante = '$idint'");
                                    $name1=mysqli_fetch_array($ejecuta);
                                    $name2=$name1['nombre_integrante'];
                                    $CIF=$name1['CIF'];
                                    $idintegrante=$name1['id_Integrante'];
                                    $idproyecto=$name1['id_Proyecto'];
                                    $idcarrera=$name1['id_carrera'];
                                    


                                    ?>
									<input id="nombre" name="nombre" placeholder="Ingresar Nombre..." value="<?php  echo $name2;?>" class="form-control"  type="text" required>
									<input type="hidden" id="idintegrante" name="idintegrante" value="<?php echo $idintegrante;?>"  class="form-control"  type="text" >
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input id="cif" name="cif" placeholder="Ingresar CIF" value="<?php echo $CIF; ?>" class="form-control"  type="text" required>
								</div>
							</div>
						</div>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<select id="proyecto" name="proyecto" class="form-control">	
											<?php
										$res=mysqli_query($conexion,"select * from proyectos INNER JOIN integrante ON proyectos.id_Proyecto = integrante.id_Proyecto AND integrante.id_integrante = $idint");
										...
										?>
											<?php
										$res2=mysqli_query($conexion,"select * from proyectos where id_Proyecto != $idproyecto");
										while($row2=mysqli_fetch_array($res2))
										{
										?>
											<option value="<?php echo $row2["id_Proyecto"];?>"><?php echo $row2["nombre_Proyecto"];?></option>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<select id="carrera" name="carrera" class="form-control">	
											<?php
										$res3=mysqli_query($conexion,"select * from carreras INNER JOIN integrante ON carreras.id_carrera = integrante.id_carrera AND integrante.id_integrante = $idint");
										...
										?>
											<?php
										$res4=mysqli_query($conexion,"select * from carreras where id_carrera != $idcarrera");
	...
	$(document).ready(function(){
		$('#registrarNuevo').click(function(){
			...
			cadena= "nombre=" + $('#nombre').val() +
					...
					$.ajax({
						type:"POST",
						url:"../funciones/updateintegrantes.php",
						data:cadena,
						success:function(r){
