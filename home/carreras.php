			...
			<div class="container">
				...
				<div class="well form-horizontal">
					<fieldset>
						...
						<!-- Form Name -->
						<legend class="text-middle" align="center">Agregar Carrera</legend>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<select id="facultad" name="facultad" class="form-control" >	
											<option disabled selected value="0">Seleccione una Facultad</option>
											<?php
										$res=mysqli_query($conexion,"select * from facultades");
