...
<div id="wrapper">    
		...
		<div class="main">
			...
			<div class="container">
						...
						<!-- Form Name -->
						<legend class="text-center">Administrar jurados</legend>
						...
						<!-- INICIO BUSCADOR-->
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre, apellido, usuario o categoria" onkeyup='load(1);'>
							</div>
							...
							<div class="col-md-3">
								...
								<span id="loader"></span>
							    </div><a class='btn btn-info' href='jurados.php' >Agregar Jurado</a>
	...
	<script type="text/javascript" src="../js/buscar_jurado.js"></script>
	                     <!-- FIN BUSCADOR-->
